  ...
  Utils.loadTemplates = function() {
    require(_.values(Templates), function() {
      ...
      for (var t in fragments) {
        Utils.templates[t] = _.template(fragments[t]);
      }
...
globalCache = new Utils.Cache();

var UserPermissions = Utils.CachedModel.extend({  
...
//N.B. NELLE LINEE SEGUENTI VIENE COMMENTATA LA FETCH PERCHE NON USATA
